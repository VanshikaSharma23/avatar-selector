import React, { useState, Suspense, useRef, useLayoutEffect, useEffect } from "react";
import "./index.css";
...
// Behavioural Rules Services
import { loadConfig, saveConfig, getConfig } from "./services/behaviouralRulesService";
import { executeBehaviouralRules } from "./services/behaviouralRulesEngine";
...
export default function App() {
  ...
  // Load saved behavioural rules configuration on mount
  useEffect(() => {
    const saved = loadConfig();
    if (saved) {
      setTeachingStyle(saved.teachingStyle || "");
      setLanguageLevel(saved.languageLevel || "");
      setBehaviourRules(saved.behaviourRules || []);
                    ...
                    {savedConfig && (
                      <div className="saved-config-display">
                        ...
                        <div className="config-summary">
                          ...
                          {savedConfig.behaviourRules && savedConfig.behaviourRules.length > 0 && (
